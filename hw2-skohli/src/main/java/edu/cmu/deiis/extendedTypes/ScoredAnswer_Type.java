...
/* First created by JCasGen Thu Sep 19 17:41:26 EDT 2013 */
...
public class ScoredAnswer_Type extends AnswerScore_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.extendedTypes.ScoredAnswer");
  ...
  public String getAnswerText(int addr) {
      ...
      jcas.throwFeatMissing("answerText", "edu.cmu.deiis.extendedTypes.ScoredAnswer");
